...
urlpatterns = [
    ...
    path('wheels/', views.MyWheels.as_view(), name='wheels'),
    path('wheels_all_active/', views.AllActiveWheels.as_view(), name='wheels-all-active'),
    path('wheels_all_completed/', views.AllCompletedWheels.as_view(), name='wheels-all-completed'),
